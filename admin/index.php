    ...
    <section class="team">
        <div class="team_card">
            <img src="./images/couples.jpg" onclick="window.location.href='<?= root_url ?>admin/single_candidate.php'">
            <div class="team_desc">
                <h3>APC party</h3>
    ...
    <!--to top-->
    <div class="to_top_button"><a href="<?= root_url ?>admin/index.php#top"><ion-icon name="arrow-up-outline"></ion-icon></a></div>
    <?php
